      ...
      <div class="col2">
        <div class="fitting_box">
          ...
          <div class="control basic">
            ...
            <div class="row">
              <input type="text" id="common_input" placeholder="パターンを選択 または コンマで区切って入力 (例: 5,3,1,4,2)" size="24"  list="common_input_example" />
              <datalist id="common_input_example">
              ...
              <input type="button" value="入力セット" title="入力をセットする" onclick="animationSet('common_input')" />
            </div>
          </div>
        </div>
      </div>
